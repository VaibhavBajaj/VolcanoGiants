...
@RegisterPlugin
@Produces(VolcanoHeightFacet.class)
public class VolcanoHeightProvider implements FacetProviderPlugin {
    ...
    public void process(GeneratingRegion region) {
        ...
        Border3D border = region.getBorderForFacet(VolcanoHeightFacet.class);
        VolcanoHeightFacet facet = new VolcanoHeightFacet(region.getRegion(), border);
        ...
        region.setRegionFacet(VolcanoHeightFacet.class, facet);
    }
}